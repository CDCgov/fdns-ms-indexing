...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("FDNS Indexing Microservice")
				.description("This is the indexing service layer for the Data Lake. The indexing layer is also known as the navigation layer.")
